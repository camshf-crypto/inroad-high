...
const MINDMAP_STRUCTURE = [
  ...
  {
    key: "학교관심" as keyof MindmapBranch,
    icon: "🏠",
    questions: [
...
const MATCHING_GUIDE: Record<
  keyof ExperienceMatching,
    ...
    questions: [
      {
        ...
        guide:
          '공부할 때 무작정 한 게 아니라 "목표 → 계획"의 과정이 있었는지 떠올려요.',
        example:
          '"2학년 때 영어 회화 약점을 느끼고, 6개월간 매주 영자신문 1편 읽기를 목표로 세웠다"',
      },
      {
        title: "실제로 어떻게 학습했고 어려움은 어떻게 극복했어?",
        guide:
          "계획대로 다 안 됐을 수 있어요. 막힌 부분을 어떻게 해결했는지 솔직하게 적어요.",
        example:
          '"처음엔 한 기사 읽는데 1시간 걸려 좌절했지만, 단어 노트를 만들어 매주 30개씩 외웠다"',
      },
      {
        title: "진로체험·동아리·꿈끼 활동 중 가장 의미 있었던 건?",
        guide: "교과 외 활동 중 본인의 진로나 꿈과 연결된 활동을 골라요.",
        example:
          '"과학동아리 부장으로 1년간 매월 실험 프로젝트를 기획·진행했다"',
      },
      {
        title: "결과를 평가하고 무엇을 느꼈어?",
        guide:
          '"재미있었다" 말고, 구체적으로 뭘 배웠고 어떻게 성장했는지 적어요.',
        example:
          '"꾸준함의 힘을 알게 됐고, 영어 외에 다른 분야도 6개월 단위로 도전하는 습관이 생겼다"',
      },
    ],
  },
  지원동기: {
    ...
    questions: [
      {
        ...
        guide:
          "학교 홈페이지에서 건학이념·인재상을 확인하고, 내 가치관과 맞는 한 가지를 골라요.",
        example:
          "\"인천하늘고의 '글로벌 항공인재 양성' 이념이 가장 와닿았다.\"",
      },
      {
        title: "그 이념·특성과 연결되는 내 경험은?",
        guide:
          "3단계에서 매칭한 경험을 활용해요. 구체적인 사건과 숫자를 넣으면 좋아요.",
        example:
          '"5년간 비행기 모형 30개를 조립하며 항공역학 유튜브 강의를 50편 이상 봤다"',
      },
      {
        title: "왜 다른 학교가 아니라 이 학교여야 해?",
        guide:
          "이 학교만의 특별한 점(프로그램, 동아리, 환경 등)을 구체적으로 적어요.",
        example:
          '"인천공항과 가까워 항공산업 현장 학습이 가능하고, 항공물리 동아리가 있는 학교는 여기뿐이다"',
      },
      {
        title: "입학하면 어떤 학생이 되고 싶어?",
        guide:
          '단순한 다짐("열심히 하겠다") 말고, 구체적으로 뭘 하고 싶은지 적어요.',
        example:
          '"항공물리 동아리에 들어가 드론 자작 프로젝트에 참여하고 싶다"',
      },
    ],
  },
  진로계획: {
    ...
    questions: [
      ...
      },
      {
        ...
        guide:
          "단순히 멋있어서가 아니라, 어떤 경험이 그 분야로 이끌었는지 적어요.",
        example:
          '"5학년 때 본 인천공항 항공기 정비사 다큐멘터리가 결정적이었다"',
      },
      {
        title: "그 진로를 위해 지금까지 한 노력은?",
        guide: "독서, 강의 시청, 동아리, 대회 참가 등 구체적으로.",
        example:
          '"항공역학 유튜브 강의 50편 시청, 비행기 모형 30개 조립, 과학동아리 부장 1년"',
      },
      {
        title: "5년 후, 10년 후 모습은 어떨까?",
        guide: "막연한 꿈이 아니라 구체적인 단계로 그려요.",
        example:
          '"5년 후 항공우주공학과 학생으로 드론 동아리 활동, 10년 후 무인기 연구원"',
      },
    ],
  },
  인성: {
    ...
    questions: [
      {
        ...
        guide:
          "거창한 봉사 말고 일상 속 작은 배려도 좋아요. 봉사체험활동도 포함.",
        example:
          '"수학을 어려워하던 짝꿍에게 1학기 동안 매일 점심시간 멘토링했다"',
      },
      {
        title: "그 과정에서 어려웠던 점과 배운 점은?",
        guide: "도와주는 게 무조건 쉽진 않았을 거예요. 솔직하게 적어요.",
        example:
          '"내 방식대로만 설명해 처음엔 이해 못했지만, 짝꿍 입장에서 다시 풀어 설명하며 배려를 배웠다"',
      },
      {
        title: "팀에서 갈등이 있었을 때 어떻게 해결했어?",
        guide:
          "팀 활동에서 의견이 안 맞을 때 어떻게 풀었는지 떠올려요. (협력·타인존중)",
        example:
          '"동아리 발표 주제로 의견이 갈렸을 때 투표 대신 각자 이유를 듣고 절충안을 도출했다"',
      },
      {
...
export default function EssayWizard({
  ...
  const [activeSectionTab, setActiveSectionTab] =
    useState<keyof SectionAnswers>("자기주도학습");
  ...
  // 🎯 2단계 마인드맵 현재 보고 있는 가지 인덱스 (0~4)
  const [currentBranchIdx, setCurrentBranchIdx] = useState(0);

  const { data: savedWizard, isLoading: isLoadingWizard } =
    useEssayWizard(essayId);
  ...
  useEffect(() => {
    if (savedWizard && isInitialLoadRef.current) {
      ...
      setData({
        keywords: savedWizard.keywords?.length
          ? savedWizard.keywords
          : EMPTY_DATA.keywords,
        mindmap: mergedMindmap,
        matching:
          savedWizard.matching && Object.keys(savedWizard.matching).length
            ? savedWizard.matching
            : EMPTY_DATA.matching,
        sections:
          savedWizard.sections && Object.keys(savedWizard.sections).length
            ? savedWizard.sections
            : EMPTY_DATA.sections,
      });
    ...
    if (exists) {
      setData((prev) => ({
        ...
        keywords: prev.keywords.map((k) =>
          k.keyword === kw ? { keyword: "", experience: "" } : k,
        ),
      }));
    } else {
      if (filled >= 5) return;
      setData((prev) => {
        ...
        if (idx >= 0)
          newKws[idx] = { keyword: kw, experience: newKws[idx].experience };
  ...
  const usedExperiences = useMemo(() => {
    ...
    Object.values(data.matching).forEach((arr: string[]) =>
      arr.forEach((e: string) => used.add(e)),
    );
    return used;
  }, [data.matching]);

  const moveExpToSection = (
    text: string,
    section: keyof ExperienceMatching,
  ) => {
    setData((prev) => {
  ...
  const updateSubAnswer = (
    section: keyof SectionAnswers,
    field: keyof SubAnswer,
    value: string,
  ) => {
    setData((prev) => ({
      ...prev,
  ...
  const experienceCheck = useMemo(() => {
    const allMatched = (
      Object.keys(data.matching) as Array<keyof ExperienceMatching>
    ).flatMap((sec) =>
      data.matching[sec].map((text) => ({ section: sec, text })),
    );
  ...
  const experienceAppearedCount = experienceCheck.filter(
    (e) => e.appears,
  ).length;
  const totalMatchedExp = experienceCheck.length;

  const isStep1Done = filledKeywords >= 3;
  const filledMindmap = (Object.values(data.mindmap) as string[][])
    .flat()
    .filter((s) => s.trim()).length;
  const isStep2Done = filledMindmap >= 4;
  const matchedCount = (Object.values(data.matching) as string[][]).flat()
    .length;
  const isStep3Done = matchedCount >= 2;
  const filledSections = (
    Object.keys(data.sections) as Array<keyof SectionAnswers>
  ).filter((sec) =>
    Object.values(data.sections[sec]).some((v) => v.trim()),
  ).length;
  ...
  const currentBranchFilled = currentBranch
    ? data.mindmap[currentBranch.key].filter((s) => s.trim()).length
    : 0;
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <div>
            ...
            <div className="text-[10px] text-ink-muted leading-[1.3] flex items-center gap-1">
              ...
              {saveStatus === "saved" && (
                <span className="text-emerald-600">· ✓ 자동저장됨</span>
              )}
            </div>
          </div>
        </div>
          ...
          {STEPS.map((s, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-[12px] font-bold transition-all ${
                      isActive
                        ? "bg-brand-middle text-white shadow-[0_4px_12px_rgba(16,185,129,0.3)] scale-110 ring-4 ring-brand-middle-pale"
                        : isPast
                          ? "bg-brand-middle-dark text-white"
                ...
                {!isLast && (
                  <div
                    className={`flex-1 h-0.5 mx-3 ${isPast ? "bg-brand-middle" : "bg-gray-200"}`}
                  />
                )}
              </div>
            );
        ...
        >
          ...
          {currentStep === 1 && (
            <div className="bg-white border border-line rounded-2xl p-7 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
              <h2 className="text-[18px] font-extrabold text-ink mb-2 tracking-tight">
                1단계 · 나의 키워드 5개 잡기
              </h2>
              <p className="text-[12.5px] text-ink-secondary leading-[1.7] mb-5">
                자소서를 쓰기 전에 "나를 보여줄 단어 5개"를 먼저 정해요.
                <br />이 키워드들이 자소서 곳곳에 자연스럽게 녹아들면 글에
                일관성이 생겨요.
              </p>
              <div className="bg-brand-middle-pale border border-brand-middle-light rounded-xl px-4 py-3 mb-5 flex gap-3">
                <div className="text-2xl flex-shrink-0"></div>
                <div>
                  <div className="text-[12px] font-bold text-brand-middle-dark mb-1">
                    AI 추천 — {schoolName}에 어울리는 키워드
                  </div>
                  <div className="text-[12px] text-ink-secondary leading-[1.6]">
                    아래 추천 중에서 골라도 되고, 직접 입력해도 돼요. 키워드
                    5개를 정하면 다음 단계로 갈 수 있어요!
                  </div>
                </div>
              </div>
              <div className="mb-5">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {SUGGESTED_KEYWORDS.map((kw) => {
                    const selected = data.keywords.some(
                      (k) => k.keyword === kw,
                    );
                    return (
                      <button
                        key={kw}
                        type="button"
                        onClick={() => toggleSuggestKeyword(kw)}
                ...
                {data.keywords.map((kw, i) => (
                  <div key={i} className="flex gap-2 mb-2">
                    ...
                    <input
                      value={kw.experience}
                      onChange={(e) =>
                        updateKeyword(i, "experience", e.target.value)
                      }
          ...
          {currentStep === 2 && (
            <div className="bg-white border border-line rounded-2xl p-7 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
              ...
              <p className="text-[12.5px] text-ink-secondary leading-[1.7] mb-5">
                머릿속에 흩어진 경험을 5개 가지로 한꺼번에 꺼내요.
                <br />
                <strong>완성된 문장 말고 단어 나열로 충분해요!</strong> 30초
                이상 안 떠오르면 다음 칸으로 넘어가요.
              </p>
              <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-5 flex gap-3">
                ...
                <div>
                  ...
                  <div className="text-[12px] text-amber-900 leading-[1.6]">
                    "기억에 남는 사건"보다 "내가 1주일 이상 시간을 들인 일"이
                    자소서 재료가 돼요. 동아리 활동, 교내 대회, 읽은 책, 친구와
                    협력한 프로젝트 — 사소해 보여도 다 적어보세요.
                    <br />
                    <strong className="text-sky-700">🏠 학교관심</strong>은
                    지원동기에 쓸 재료라서 꼭 적어주세요!
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-4 bg-gray-50 border border-line rounded-xl px-4 py-3">
                <div className="flex items-center gap-2">
                  {MINDMAP_STRUCTURE.map((b, idx) => {
                    const filled = data.mindmap[b.key].filter((s) =>
                      s.trim(),
                    ).length;
                      ...
                      >
                        <div
                          className={`w-9 h-9 rounded-full flex items-center justify-center text-base transition-all ${
                            isCurrent
                              ? "bg-brand-middle text-white scale-110 shadow-[0_4px_12px_rgba(16,185,129,0.3)] ring-4 ring-brand-middle-pale"
                              : hasContent
                                ? "bg-brand-middle-pale border-2 border-brand-middle text-brand-middle-dark"
                                : "bg-white border-2 border-line text-ink-muted group-hover:border-brand-middle-light"
                          }`}
                        >
                          {b.icon}
                        </div>
                ...
                <div className="text-[12px] font-bold text-ink-secondary tabular-nums">
                  {currentBranchIdx + 1} / {MINDMAP_STRUCTURE.length}
                </div>
              </div>
              ...
              {currentBranch && (
                <div className="bg-gradient-to-br from-gray-50 to-white border-2 border-brand-middle-light rounded-xl p-6">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-14 h-14 rounded-2xl bg-white border-2 border-brand-middle-light flex items-center justify-center text-3xl shadow-sm">
                      {currentBranch.icon}
                    </div>
                    <div>
                      ...
                      <div className="text-[11px] text-ink-secondary mt-0.5">
                        {currentBranchFilled}/4개 적었어요
                        {currentBranch.key === "학교관심" && (
                          <span className="ml-2 text-[10px] font-bold text-sky-700 bg-sky-100 px-2 py-0.5 rounded-full">
                            ⭐ 지원동기 재료
                          </span>
                        )}
                      </div>
                  ...
                  <div className="space-y-3">
                    {currentBranch.questions.map((q, i) => (
                      <div key={i}>
                        ...
                        <input
                          value={data.mindmap[currentBranch.key][i]}
                          onChange={(e) =>
                            updateMindmap(
                              currentBranch.key,
                              i,
                          ...
                          placeholder={currentBranch.placeholders[i]}
                          className="w-full h-11 px-3.5 bg-white border border-line rounded-lg text-[13px] focus:outline-none focus:border-brand-middle focus:ring-2 focus:ring-brand-middle/10 transition-all placeholder:text-ink-muted"
                        />
                      </div>
                    ))}
                  </div>
              ...
              <div className="flex items-center justify-between mt-5 gap-3">
                <button
                  type="button"
                  onClick={() =>
                    setCurrentBranchIdx((p) => Math.max(0, p - 1))
                  }
                  disabled={currentBranchIdx === 0}
                  className="h-11 px-5 bg-white border border-line rounded-lg text-[13px] font-semibold text-ink-secondary hover:bg-gray-50 transition-colors disabled:opacity-30 disabled:cursor-not-allowed"
                >
                  ← 이전
                </button>
                ...
                <div className="text-[11px] text-ink-muted font-medium text-center">
                  {currentBranchIdx === MINDMAP_STRUCTURE.length - 1 ? (
                    ...
                    <span>
                      다음:{" "}
                      <strong className="text-brand-middle-dark">
                        {MINDMAP_STRUCTURE[currentBranchIdx + 1].icon}{" "}
                        {MINDMAP_STRUCTURE[currentBranchIdx + 1].key}
                      </strong>
                    </span>
                  )}
                </div>
                ...
                <button
                  type="button"
                  onClick={() =>
                    setCurrentBranchIdx((p) =>
                      Math.min(MINDMAP_STRUCTURE.length - 1, p + 1),
                    )
                  }
                  disabled={currentBranchIdx === MINDMAP_STRUCTURE.length - 1}
                  className="h-11 px-5 bg-brand-middle hover:bg-brand-middle-hover text-white rounded-lg text-[13px] font-semibold transition-all hover:-translate-y-px hover:shadow-btn-middle disabled:opacity-30 disabled:cursor-not-allowed disabled:hover:translate-y-0 disabled:hover:shadow-none"
                >
                  다음 →
                </button>
              </div>
          ...
          {currentStep === 3 && (
            <div className="bg-white border border-line rounded-2xl p-7 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
              <h2 className="text-[18px] font-extrabold text-ink mb-2 tracking-tight">
                3단계 · 경험을 자소서 항목에 연결하기
              </h2>
              <p className="text-[12.5px] text-ink-secondary leading-[1.7] mb-5">
                2단계에서 꺼낸 경험들을 어느 자소서 항목에 쓸지 매칭해요.
                <br />각 항목 박스 안에{" "}
                <strong>"어떤 경험을 매칭하면 좋은지 예시"</strong>를
                보여줄게요!
              </p>
              <div className="bg-brand-middle-pale border border-brand-middle-light rounded-xl px-4 py-3 mb-5 flex gap-3">
                <div className="text-2xl flex-shrink-0"></div>
              ...
              <div className="grid grid-cols-[280px_1fr] gap-4">
                <div className="bg-gray-50 border border-line rounded-xl p-3">
                  <div className="text-[11px] font-bold text-ink-muted uppercase tracking-wider mb-2 px-1">
                    📦 내 경험 카드 ({experienceCards.length}개)
                  </div>
                  {experienceCards.length === 0 ? (
                    <div className="text-[11px] text-ink-muted text-center py-6">
                      2단계에서
                      <br />
                      경험을 먼저 적어주세요
                    </div>
                    ...
                    experienceCards.map((card, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className={`bg-white border rounded-lg px-3 py-2 mb-1.5 transition-all ${used ? "opacity-40 border-line" : "border-line"}`}
                        >
                          <div className="flex items-center gap-1.5 mb-1">
                            <span
                              className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full border ${CATEGORY_COLORS[card.category]}`}
                            >
                          ...
                          <div className="text-[12px] text-ink leading-[1.5] mb-1.5">
                            {card.text}
                          </div>
                          {!used && (
                            <div className="grid grid-cols-2 gap-1">
                              {(
                                ...
                                <button
                                  ...
                                  type="button"
                                  onClick={() =>
                                    moveExpToSection(card.text, sec)
                                  }
                ...
                <div className="space-y-3">
                  {(
                    Object.keys(MATCHING_GUIDE) as Array<
                      keyof ExperienceMatching
                    >
                  ).map((secKey) => {
                    ...
                    return (
                      <div
                        ...
                        className={`border-2 rounded-xl p-4 transition-all ${
                          matched.length > 0
                            ? "border-brand-middle bg-brand-middle-pale/40"
                          ...
                          <div className="bg-gradient-to-br from-amber-50 to-yellow-50 border border-amber-200 rounded-lg px-3 py-2.5 mb-2">
                            ...
                            <div className="space-y-1">
                              {sec.examples.map((example, i) => (
                                <div
                                  key={i}
                                  className="text-[11px] text-amber-900 leading-[1.5]"
                                >
                                  {example}
                                </div>
                              ))}
                            ...
                            <div className="text-[10.5px] text-amber-700 mt-2 pt-1.5 border-t border-amber-200/60">
                              👈 왼쪽 경험 카드에서 "<strong>{secKey}</strong>"
                              버튼을 눌러 추가하세요
                            </div>
                          </div>
                        )}
                        ...
                        {matched.length > 0 && (
                          <div className="flex flex-wrap gap-1.5">
                            {matched.map((text) => (
                              <span
                                key={text}
                                className="inline-flex items-center gap-1 px-2.5 py-1 bg-white border border-brand-middle-light rounded-full text-[11px] font-semibold text-brand-middle-dark"
                              >
                                {text}
                                <button
                                  type="button"
                                  onClick={() =>
                                    removeExpFromSection(text, secKey)
                                  }
          ...
          {currentStep === 4 && (
            <div className="grid grid-cols-[340px_1fr] gap-4 items-start">
              <div className="bg-white border border-line rounded-2xl p-5 shadow-[0_4px_16px_rgba(15,23,42,0.04)] sticky top-0 max-h-[calc(100vh-220px)] overflow-y-auto">
                <div className="text-[14px] font-extrabold text-ink mb-1 flex items-center gap-1.5">
                  📋 내 참고 자료
                </div>
                ...
                <div className="mb-5">
                  ...
                  {data.keywords.filter((k) => k.keyword.trim()).length ===
                  0 ? (
                    ...
                    <div className="space-y-1.5">
                      {data.keywords
                        ...
                        .map((kw, i) => (
                          <div
                            key={i}
                            className="bg-gradient-to-br from-emerald-50 to-teal-50 border border-brand-middle-light rounded-lg px-3 py-2"
                          >
                            <div className="text-[12px] font-extrabold text-brand-middle-dark">
                              #{kw.keyword}
                            </div>
                            {kw.experience && (
                              <div className="text-[10px] text-ink-secondary mt-0.5 leading-[1.4]">
                                💭 {kw.experience}
                              </div>
                            )}
                          </div>
                ...
                <div className="mb-3">
                  <div className="text-[11px] font-extrabold text-brand-middle-dark uppercase tracking-wider mb-2 flex items-center gap-1">
                    📌 {activeSectionTab}에 매칭한 경험 (
                    {matchedCardsForCurrentSection.length}개)
                  </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              type="button"
                              onClick={() =>
                                setExpandedExp(isExpanded ? null : card.text)
                              }
                              className="w-full px-3 py-2 text-left hover:bg-gray-50 transition-colors"
                            >
                              <div className="flex items-start gap-1.5 mb-1">
                                <span
                                  className={`text-[9px] font-bold px-1.5 py-0.5 rounded-full border flex-shrink-0 ${CATEGORY_COLORS[card.category]}`}
                                >
                                  {card.branchIcon}
                                </span>
                                <span className="text-[11.5px] font-bold text-ink leading-[1.4] flex-1">
                                  {card.text}
                                </span>
                                <span
                                  className={`text-[10px] text-ink-muted flex-shrink-0 transition-transform ${isExpanded ? "rotate-180" : ""}`}
                                >
                                  ▼
                                </span>
                              </div>
                            ...
                            {isExpanded && (
                              <div className="px-3 pb-2.5 bg-gradient-to-br from-emerald-50/40 to-white border-t border-brand-middle-light/50">
                                <div className="text-[9px] font-bold text-ink-muted uppercase tracking-wider mt-2 mb-1">
                                  📍 2단계 위치
                                </div>
                                <div className="bg-white border border-line rounded px-2 py-1.5 mb-2">
                                  <div className="text-[10px] text-ink-secondary">
                                    {card.branchIcon} {card.category} 가지의
                                  </div>
                                  <div className="text-[10.5px] font-bold text-brand-middle-dark">
                                    "{card.questionLabel}"
                                  </div>
                                </div>
                ...
                <div className="mt-4 pt-3 border-t border-line">
                  ...
                  {(
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-2 py-1.5 mb-1 rounded transition-colors ${
                    ...
                    >
                      <span
                        className={`text-[11px] font-semibold ${activeSectionTab === sec ? "text-brand-middle-dark" : "text-ink-secondary"}`}
                      >
                        {SECTION_QUESTIONS[sec].icon} {sec}
                      </span>
                      <span className="text-[10px] font-bold text-brand-middle-dark">
                        {data.matching[sec].length}개
                      </span>
                    </button>
                  ))}
                </div>
              ...
              <div className="bg-white border border-line rounded-2xl p-6 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
                ...
                <div className="flex gap-1 mb-5 bg-gray-50 p-1 rounded-lg">
                  {(
                    Object.keys(SECTION_QUESTIONS) as Array<
                      keyof typeof SECTION_QUESTIONS
                    >
                  ).map((sec) => {
                    const filled = Object.values(data.sections[sec]).filter(
                      (v) => v.trim(),
                    ).length;
                    return (
                      <button
                        ...
                        className={`flex-1 h-10 px-2 rounded-md text-[11.5px] font-bold transition-all ${
                          activeSectionTab === sec
                      ...
                      >
                        {filled > 0 && (
                          <span className="text-brand-middle mr-1">✓</span>
                        )}
                        {SECTION_QUESTIONS[sec].icon} {sec}
                      </button>
                    );
                ...
                <div className="bg-brand-middle-pale border border-brand-middle-light rounded-xl px-4 py-3 mb-4">
                  <div className="text-[11px] font-bold text-brand-middle-dark mb-0.5">
                    자소서{" "}
                    {Object.keys(SECTION_QUESTIONS).indexOf(activeSectionTab) +
                      1}
                    번 항목
                  </div>
                  <div className="text-[14px] font-extrabold text-ink mb-1">
                    {SECTION_QUESTIONS[activeSectionTab].icon}{" "}
                    {SECTION_QUESTIONS[activeSectionTab].label}
                  </div>
                  <div className="text-[11px] text-ink-secondary">
                    권장 분량: 350~400자 · 현재{" "}
                    <span className="font-bold text-brand-middle-dark">
                      {draftFor(activeSectionTab).replace(/\s/g, "").length}자
                    </span>
                  </div>
                </div>
                ...
                {SECTION_QUESTIONS[activeSectionTab].questions.map((q, i) => {
                  ...
                  return (
                    <div
                      key={i}
                      className="mb-4 border border-line rounded-xl p-4 bg-gray-50"
                    >
                      <div className="flex items-start gap-2 mb-2">
                        ...
                        <span className="text-[14px] font-bold text-ink leading-[1.5]">
                          {q.title}
                        </span>
                      </div>
                      <div className="text-[11px] text-ink-secondary leading-[1.6] mb-1.5 ml-8">
                        {q.guide}
                      </div>
                      <div className="text-[11px] text-ink-muted leading-[1.6] mb-2 ml-8 italic">
                        <strong className="not-italic">예시:</strong>{" "}
                        {q.example}
                      </div>
                      <textarea
                        value={value}
          ...
          {currentStep === 5 && (
            <div className="bg-white border border-line rounded-2xl p-7 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
              ...
              <p className="text-[12.5px] text-ink-secondary leading-[1.7] mb-5">
                4개 항목을 합친 전체 자소서예요. 셀프 점검 후 선생님께
                제출하세요.
              </p>
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                <div className="bg-gray-50 border border-line rounded-xl p-3 text-center">
                  ...
                  <div
                    className={`text-[18px] font-extrabold ${totalCharCount > 1500 ? "text-red-500" : "text-brand-middle-dark"}`}
                  >
              ...
              {keywordCheck.length > 0 && (
                <div className="mb-5 bg-gradient-to-br from-emerald-50 to-teal-50 border-2 border-brand-middle-light rounded-xl p-4">
                  ...
                  <div className="text-[11px] text-ink-secondary mb-3">
                    키워드 자체나 그 키워드의 경험 단어가 자소서 본문에 등장하면
                    ✅로 표시돼요!
                  </div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div
                            className={`text-[12px] font-bold ${
                              k.appears ? "text-emerald-700" : "text-amber-700"
                            }`}
                          >
                            #{k.keyword}
                          </div>
                          <div
                            className={`text-[10px] ${
                              k.appears ? "text-emerald-600" : "text-amber-600"
                            }`}
                          >
                  ...
                  {keywordAppearedCount < filledKeywords && (
                    <div className="mt-3 bg-white border border-amber-200 rounded-lg px-3 py-2 flex gap-2">
                      ...
                      <div className="text-[11px] text-amber-800 leading-[1.6]">
                        <strong>
                          등장하지 않은 키워드가{" "}
                          {filledKeywords - keywordAppearedCount}개 있어요!
                        </strong>
                        <br />
                ...
                <div className="mb-5 bg-gradient-to-br from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {(
                      ...
                      const sectionExps = experienceCheck.filter(
                        (e) => e.section === sec,
                      );
                        ...
                        >
                          ...
                          <div className="space-y-1">
                            {sectionExps.map((exp, i) => (
                              <div
                                key={i}
                                className={`flex items-start gap-1.5 text-[11px] leading-[1.5] ${
                                  exp.appears
                                    ? "text-emerald-700"
                                    : "text-amber-700"
                                }`}
              ...
              <div className="space-y-4">
                {(
                  ...
                  const allKeywords = data.keywords.filter((k) =>
                    k.keyword.trim(),
                  );

                  const allExperiences: string[] = [];
                  (
                    Object.keys(data.mindmap) as Array<keyof MindmapBranch>
                  ).forEach((branch) => {
                    ...
                    >
                      ...
                      {draft && allKeywords.length > 0 && (
                        <div className="flex flex-wrap gap-1 items-center mt-2 pt-2 border-t border-line-light">
                          <span className="text-[10px] text-ink-muted mr-1">
                            🎯 키워드:
                          </span>
                          {allKeywords.map((k, i) => {
                            const allWords = [
                              ...
                              ...(k.experience
                                ? extractMeaningfulWords(k.experience)
                                : []),
                            ];
                            const inThisSection = allWords.some((w) =>
                              draft.includes(w),
                            );
                            return (
                              <span
                      ...
                      {draft && allExperiences.length > 0 && (
                        <div className="flex flex-wrap gap-1 items-center mt-1.5">
                          ...
                          {allExperiences.map((exp, i) => {
                            ...
                            const inThisSection = expWords.some((w) =>
                              draft.includes(w),
                            );
                            return (
                              <span
              ...
              <div className="mt-5 bg-amber-50 border border-amber-200 rounded-xl p-4">
                <div className="text-[13px] font-extrabold text-amber-900 mb-3">
                  ✅ 제출 전 셀프 점검
                </div>
                {[
                  ...
                  >
                    ...
                    />
                    <span className="text-[12.5px] text-ink leading-[1.6]">
                      {text}
                    </span>
                  </label>
                ))}
          ...
          {currentStep === 6 && (
            <div className="bg-white border border-line rounded-2xl p-7 shadow-[0_4px_16px_rgba(15,23,42,0.04)]">
              ...
              <p className="text-[12.5px] text-ink-secondary leading-[1.7] mb-5">
                4개 항목별로 선생님 피드백을 받고, 그에 맞춰 자소서를
                수정해보세요.
                <br />
                수정한 후 <strong>재제출</strong>하면 선생님이 추가 피드백을
                드려요.
              </p>

              {(["자기주도학습", "지원동기", "진로계획", "인성"] as const).map(
                (sec) => {
                  const sectionInfo = SECTION_QUESTIONS[sec];
                  ...
                  return (
                    <div
                      key={sec}
                      className="mb-6 border border-line rounded-xl p-5 bg-gray-50"
                    >
                        ...
                        <div className="bg-brand-middle-pale border border-brand-middle-light rounded-lg px-4 py-3 mb-3">
                          ...
                          <div className="space-y-2">
                            {sectionFeedbacks.map((fb: any, i: number) => (
                              <div
                                key={i}
                                className="bg-white border border-brand-middle-light rounded-md px-3 py-2"
                              >
                                <div className="flex items-center gap-1.5 mb-1">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mt-5">
                <div className="text-[12px] text-blue-900 leading-[1.7]">
                  💡 <strong>팁:</strong> 선생님 피드백은 학원 어드민에서
                  작성됩니다. 피드백이 도착하면 위 항목별로 보여요. 수정한 후
                  하단 <strong>재제출</strong> 버튼을 눌러주세요.
                </div>
              </div>
            </div>
          )}
        ...
        <div className="max-w-[900px] mx-auto flex items-center justify-between">
          ...
          {currentStep === 5 && (
            <button
              ...
              className={`h-10 px-5 rounded-lg text-[13px] font-bold transition-all ${
                isStep4Done &&
                totalCharCount <= 1500 &&
                !submitToTeacher.isPending
