...
export default function MiddleRoadmapTab({ student, viewGrade }: Props) {
  ...
  const currentViewGrade: MiddleGradeKey = viewGrade || studentGrade
  ...
  const roadmap = MIDDLE_ROADMAP[currentViewGrade]
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isSel ? THEME.accentBg : isCur ? '#F0FDF4' : '#fff',
