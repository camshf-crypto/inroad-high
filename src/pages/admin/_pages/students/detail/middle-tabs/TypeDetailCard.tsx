// src/pages/admin/_pages/students/detail/middle-tabs/TypeDetailCard.tsx
  ...
  return (
    <div className="bg-white border border-line rounded-2xl p-6 flex flex-col">
      ...
      <div className="flex items-center justify-between mb-3">
        ...
        <span className="text-[10px] font-bold text-brand-middle-dark bg-brand-middle-pale px-2 py-0.5 rounded-full border border-brand-middle-light">
          상위 1유형
        </span>
      </div>
      ...
      <div className="mb-3">
        ...
        <div className="flex flex-wrap gap-1">
          {detail.keywords.map(kw => (
            <span
              key={kw}
              className="text-[10px] font-semibold px-2 py-0.5 bg-brand-middle-pale text-brand-middle-dark rounded-full border border-brand-middle-light"
            >
              {kw}
            </span>
          ))}
      ...
      <button
        ...
        className="mt-auto w-full py-2.5 bg-brand-middle-pale text-brand-middle-dark rounded-lg text-[12px] font-bold border border-brand-middle-light hover:bg-brand-middle-light hover:-translate-y-px transition-all"
      >
        자세히 보기 →
      </button>
    </div>
