...
const INIT_STAFF = [
  { id: 1, name: '김대표', email: 'ceo@B-KEARS.com', phone: '010-1234-5678', role: 'super_admin', status: 'active', joinDate: '2024.01.15', lastLogin: '2025.04.20 14:35', avatarColor: '#7C3AED' },
  { id: 2, name: '이매니저', email: 'manager@B-KEARS.com', phone: '010-2345-6789', role: 'operator', status: 'active', joinDate: '2024.02.01', lastLogin: '2025.04.20 14:25', avatarColor: '#2563EB' },
  { id: 3, name: '박영업', email: 'sales1@B-KEARS.com', phone: '010-3456-7890', role: 'sales', status: 'active', joinDate: '2024.02.10', lastLogin: '2025.04.20 13:55', avatarColor: '#059669' },
  { id: 4, name: '정영업', email: 'sales2@B-KEARS.com', phone: '010-4567-8901', role: 'sales', status: 'active', joinDate: '2024.03.15', lastLogin: '2025.04.20 12:20', avatarColor: '#10B981' },
  { id: 5, name: '김CS', email: 'cs1@B-KEARS.com', phone: '010-5678-9012', role: 'cs', status: 'active', joinDate: '2024.04.01', lastLogin: '2025.04.20 14:30', avatarColor: '#F59E0B' },
  { id: 6, name: '최CS', email: 'cs2@B-KEARS.com', phone: '010-6789-0123', role: 'cs', status: 'invited', joinDate: '2025.04.18', lastLogin: '-', avatarColor: '#FBBF24' },
  { id: 7, name: '정재무', email: 'finance@B-KEARS.com', phone: '010-7890-1234', role: 'finance', status: 'active', joinDate: '2024.05.10', lastLogin: '2025.04.20 14:10', avatarColor: '#EC4899' },
  { id: 8, name: '강분석', email: 'analyst@B-KEARS.com', phone: '010-8901-2345', role: 'analyst', status: 'active', joinDate: '2024.06.20', lastLogin: '2025.04.20 13:40', avatarColor: '#6B7280' },
]
                    ...
                    <div className="flex flex-col gap-3">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="example@B-KEARS.com"
                          className="w-full h-10 px-3 border border-line rounded-lg text-[13px] font-medium outline-none transition-all placeholder:text-ink-muted"
                          onFocus={e => { e.target.style.borderColor = THEME.accent; e.target.style.boxShadow = `0 0 0 3px ${THEME.accentShadow}` }}
                          onBlur={e => { e.target.style.borderColor = '#E5E7EB'; e.target.style.boxShadow = 'none' }}
                        />
