// src/pages/high-student/_pages/signup/index.tsx
            ...
            <div>
              ...
              >
                <div className={`w-5 h-5 rounded-md flex items-center justify-center text-[11px] text-white font-bold flex-shrink-0 transition-all ${
                  s.agreeAll ? 'bg-brand-high' : 'bg-white border border-line'
                }`}>
                  {s.agreeAll ? '✓' : ''}
                </div>
                <span className={`text-[13px] font-bold flex-1 ${s.agreeAll ? 'text-brand-high-dark' : 'text-ink'}`}>
                  전체 동의하기
                </span>
              </div>
              ...
              <div className="text-center mt-3">
                ...
                <button
                  onClick={() => navigate('/high-student/login')}
                    ...
                    <button
                      ...
                      className={`flex-shrink-0 h-10 px-3.5 rounded-lg text-[12px] font-semibold whitespace-nowrap border transition-all ${
                        s.phoneVerified
                          ...
                          : s.phoneCodeSent
                            ? 'bg-brand-high-pale text-brand-high-dark border-brand-high-light hover:border-brand-high'
                  ...
                  <div>
                    <label className="text-[11px] font-semibold text-ink-secondary block mb-1.5">
                      ...
                      <span className="ml-2 text-[10px] text-ink-muted font-normal">
                        (테스트용: <span className="font-bold text-brand-high-dark">123456</span>)
                      </span>
                    </label>
                    <div className="flex gap-2">
                      <div className="relative flex-1">
                        <input
                          ...
                          placeholder="6자리 숫자"
                          maxLength={6}
                          className="w-full h-10 pl-3.5 pr-16 border border-line rounded-lg text-[14px] font-bold tracking-[2px] text-center focus:outline-none focus:border-brand-high focus:ring-2 focus:ring-brand-high/10 transition-all placeholder:text-ink-muted placeholder:font-normal placeholder:tracking-normal"
                        />
                        {s.timer > 0 && (
                      ...
                      <button
                        ...
                        className="flex-shrink-0 h-10 px-3.5 bg-brand-high text-white rounded-lg text-[12px] font-semibold hover:bg-brand-high-dark transition-all"
                      >
                        확인
                      </button>
                    </div>
