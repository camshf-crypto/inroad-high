...
export default function HighPending() {
    ...
    <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center p-6 font-sans">
      <div className="bg-white border border-line rounded-3xl p-10 w-full max-w-[480px] shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
        ...
        <div className="text-center mb-6">
          <div className="w-20 h-20 mx-auto bg-gradient-to-br from-brand-high-dark to-brand-high rounded-2xl flex items-center justify-center text-4xl mb-5 shadow-[0_8px_24px_rgba(37,99,235,0.2)] relative">
        ...
        {academy.academyName && (
          <div className="bg-brand-high-pale border border-brand-high-light rounded-xl px-5 py-4 mb-5">
            <div className="text-[11px] font-bold text-brand-high-dark uppercase tracking-wider mb-1.5">
              연결된 학원
            </div>
        ...
        <div className="flex flex-col gap-2">
          <button
            ...
            disabled={checking}
            className="w-full py-3.5 bg-brand-high text-white rounded-xl text-[14px] font-bold hover:bg-brand-high-dark transition-all shadow-[0_4px_12px_rgba(37,99,235,0.25)] hover:shadow-[0_6px_16px_rgba(37,99,235,0.35)] disabled:opacity-60 flex items-center justify-center gap-2"
          >
            {checking ? (
              <>
